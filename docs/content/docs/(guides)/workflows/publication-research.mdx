  ...
  <Tab value="Step by Step">
    <Steps>
      ...
      <Step>
        ...
        **Expected output:**
        ```
        ✓ gesundheit-indikatoren-wien-2024: Citation-ready
          DOI: 10.25365/opendata-vh-2024
          Contact: open@data.wien.gv.at
          Citation: Stadt Wien (2024). Health Indicators Vienna...

        ✗ soziodemografie-austria: Missing doi/citation
        ✓ umwelt-stat-austria: Citation-ready
        ```
      ...
      <Step>
        ...
        **Expected output:**
        ```
        ✓ gesundheit-indikatoren-wien-2024: CC-BY-4.0 - Academic use approved
          Note: Requires attribution in citations
        ✓ umwelt-stat-austria: CC0-1.0 - Academic use approved
