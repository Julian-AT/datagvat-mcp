...
- [ ] Understanding of academic licensing
...
You're preparing academic papers or theses. You need citation-quality data sources. You require reproducible research data. You're publishing in peer-reviewed journals.

## What you'll accomplish

By following this workflow, you'll:
- Identify 2-3 citation-quality datasets (score ≥85)
- Verify citation metadata (DOI/citation text)
- Approve research licenses (CC-BY, CC0, ODbL)
- Generate bibliography entries (APA, BibTeX)
- Save publisher contact information
...
<Tabs items={['Complete Example', 'Step by Step']} persist groupId="workflow-detail">
  ...
  <Tab value="Step by Step">
    <Steps>
      <Step>
        ### Step 1: Semantic search with quality boost
        ...
        **Expected output:**
        ```json
        {
          "results": [
            {
              "id": "gesundheit-indikatoren-wien-2024",
              "title": "Health Indicators Vienna 2020-2024",
              "quality_score": 92,
              "modified": "2024-01-10"
            },
            {
              "id": "soziodemografie-austria",
      ...
      <Step>
        ### Step 2: Filter for citation quality (≥85)
        ...
        **Expected output:**
        ...
        Citation-quality datasets: 8/15
          ...
          gesundheit-indikatoren-wien-2024: 92/100
          soziodemografie-austria: 88/100
          umwelt-stat-austria: 87/100
          ...
        ```
      ...
      <Step>
        ### Step 3: Verify citation information
        ...
        for dataset in citation_candidates:
            ...
            if citation_ready:
                ...
                print(f"Success: {dataset['id']}: Citation-ready")
            else:
                missing = []
                if not has_contact: missing.append('contact')
                if not (has_doi or has_citation): missing.append('doi/citation')
                print(f"Error: {dataset['id']}: Missing {', '.join(missing)}")
        ```

        **Expected output:**
        ```
        Success: gesundheit-indikatoren-wien-2024: Citation-ready
          DOI: 10.25365/opendata-vh-2024
          Contact: open@data.wien.gv.at
          Citation: Stadt Wien (2024). Health Indicators Vienna...

        Error: soziodemografie-austria: Missing doi/citation
        Success: umwelt-stat-austria: Citation-ready
        ```
      ...
      <Step>
        ...
        for item in validated:
            ...
            if license in research_licenses:
                ...
                print(f"Success: {item['id']}: {license} - Academic use approved")

                # Check attribution requirements
                requires_attribution = 'BY' in license or 'ODbL' in license
                if requires_attribution:
                    print(f"  Note: Requires attribution in citations")
            else:
                print(f"Error: {item['id']}: {license} - Verify restrictions")
        ```

        **Expected output:**
        ```
        Success: gesundheit-indikatoren-wien-2024: CC-BY-4.0 - Academic use approved
          Note: Requires attribution in citations
        Success: umwelt-stat-austria: CC0-1.0 - Academic use approved
      ...
      <Step>
        ### Step 5: Export citation metadata
        ...
        **Expected output:**
        ...
        Citations saved to:
          - citations_gesundheit-indikatoren-wien-2024.txt
          - citations_umwelt-stat-austria.txt
        ```
