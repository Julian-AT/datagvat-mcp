  ...
  <Tab value="Step by Step">
    <Steps>
      ...
      <Step>
        ...
        **Expected output:**
        ```
        Success: bev-stat-wien-2024: 85
        Success: gesundheit-wien-2024: 72
        Error: regional-stats: 65 (below threshold)
      ...
      <Step>
        ...
        **Expected output:**
        ```
        Success: bev-stat-wien-2024: Schema valid (columns: year, region, value, population)
        Error: gesundheit-wien-2024: Missing columns {'region'}
      ...
      <Step>
        ...
        **Expected output:**
        ```
        Success: Exported bev-stat-wien-2024: 2048576 bytes → ./exports/bev-stat-wien-2024_20240119_140530.csv
