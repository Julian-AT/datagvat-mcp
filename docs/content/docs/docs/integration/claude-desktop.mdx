...
- **data.gv.at MCP Server** installed (see [Installation guide](/getting-started/installation))
...
- **[Your first query](/getting-started/first-query)** - Learn basic search patterns
- **[Configuration guide](/guides/configuration)** - Advanced configuration options
- **[Other clients](/integration/other-clients)** - Use with Continue, Cline, or custom clients
