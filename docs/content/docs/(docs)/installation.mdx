...
![Terminal showing uvx datagvat-mcp init command with Rich-formatted output displaying detected AI tools, configuration progress, and successful completion message.](/screenshots/cli-init.png)

<Callout type="info" title="CLI Installer Output">
...
![Terminal showing uvx datagvat-mcp doctor command with health check results showing all green checkmarks for Python version, uv availability, server loading, API connection, and tool configurations.](/screenshots/cli-doctor.png)

<Callout type="info" title="CLI Doctor Output">
...
If the issue persists, see [Troubleshooting](/docs/troubleshooting) for manual configuration.
