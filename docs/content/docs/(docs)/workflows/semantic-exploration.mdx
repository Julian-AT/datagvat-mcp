...
- [ ] Basic understanding of EU theme codes
...
You're exploring an unfamiliar research domain. You don't know exact keywords or terminology. You want to discover unexpected data sources. You're building understanding of the data landscape.

## What you'll accomplish

By following this workflow, you'll:
- Map the domain landscape (themes, publishers)
- Identify 3-5 key themes
- Prioritize 5-10 recommended datasets
- Explore related dataset connections
...
<Tabs items={['Complete Example', 'Step by Step']} persist groupId="workflow-detail">
  ...
  <Tab value="Step by Step">
    <Steps>
      <Step>
        ### Step 1: Initial broad semantic search
        ...
        **Expected output:**
        ```json
        {
          ...
          "results": [
            {
              "id": "umwelt-indikatoren-wien-2024",
              "title": "Vienna Environmental Indicators 2024"
            },
            {
              "id": "erneuerbare-energie-austria",
              "title": "Renewable Energy Statistics Austria"
            },
            {
              "id": "oeffentlicher-verkehr-wien",
      ...
      <Step>
        ### Step 2: Analyze theme distribution
      ...
      <Step>
        ...
        **Expected output:**
        ```json
        {
          "reference_dataset_id": "umwelt-indikatoren-wien-2024",
          "related_datasets": [
            {
              "id": "luftqualitaet-wien-2023",
      ...
      <Step>
        ### Step 5: Build dataset collection
