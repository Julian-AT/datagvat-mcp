        ...
        <div className="space-y-3 w-auto">
          ...
          <div className="flex items-center gap-2.5">
            <div className="min-w-0 flex-1 space-y-1 px-0.5">
              ...
              {data.mediaType && (
                <p className="font-mono text-xs truncate text-muted-foreground">{data.mediaType}</p>
              )}
            </div>
          </div>
        </div>
...
export function PromptInputAttachments({
  ...
  return (
    <div className={cn('flex flex-wrap gap-2 items-center p-3 w-full', className)} {...props}>
...
export const PromptInputTabLabel = ({ className, ...props }: PromptInputTabLabelProps) => (
  <h3 className={cn('px-3 mb-2 text-xs font-medium text-muted-foreground', className)} {...props} />
);
...
export const PromptInputTabItem = ({ className, ...props }: PromptInputTabItemProps) => (
  <div
    className={cn('flex gap-2 items-center px-3 py-2 text-xs hover:bg-accent', className)}
    {...props}
  />
);
