...
This is a placeholder image. Real Claude Desktop screenshots showing Austria MCP semantic search with query expansion will be added soon. The screenshot will demonstrate actual language detection, theme expansion, and conceptually relevant results.
</Callout>
