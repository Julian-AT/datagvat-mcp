...
export const docs = await create.docsLazy(
  ...
  'content/docs',
  {
    ...
    'reference/tools/meta.json': __fd_glob_10,
  },
  {
    'index.mdx': __fd_glob_11,
    'getting-started/first-query.mdx': __fd_glob_12,
    'getting-started/index.de.mdx': __fd_glob_13,
    'getting-started/index.mdx': __fd_glob_14,
    'getting-started/installation.de.mdx': __fd_glob_15,
    'getting-started/installation.mdx': __fd_glob_16,
    'getting-started/quick-reference.mdx': __fd_glob_17,
    'getting-started/quickstart.mdx': __fd_glob_18,
    'getting-started/troubleshooting.mdx': __fd_glob_19,
    'tutorials/getting-started.de.mdx': __fd_glob_20,
    'tutorials/getting-started.mdx': __fd_glob_21,
    '(advanced)/advanced/architecture.mdx': __fd_glob_22,
    '(advanced)/advanced/error-handling.mdx': __fd_glob_23,
    '(advanced)/advanced/fastmcp-internals.mdx': __fd_glob_24,
    '(advanced)/advanced/testing.mdx': __fd_glob_25,
    '(advanced)/best-practices/caching-strategies.mdx': __fd_glob_26,
    '(advanced)/best-practices/comparison-tables.mdx': __fd_glob_27,
    '(advanced)/best-practices/optimization.de.mdx': __fd_glob_28,
    ...
    '(guides)/workflows/publication-research.mdx': __fd_glob_52,
    '(guides)/workflows/quality-assessment.mdx': __fd_glob_53,
    '(guides)/workflows/semantic-exploration.mdx': __fd_glob_54,
  },
  {
