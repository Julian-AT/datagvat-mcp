...
import { frontmatter as __fd_glob_24 } from "../content/docs/(advanced)/advanced/fastmcp-internals.mdx?collection=docs&only=frontmatter"
import { frontmatter as __fd_glob_23 } from "../content/docs/(advanced)/advanced/error-handling.mdx?collection=docs&only=frontmatter"
import { frontmatter as __fd_glob_22 } from "../content/docs/(advanced)/advanced/architecture.mdx?collection=docs&only=frontmatter"
