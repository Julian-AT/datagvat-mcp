...
import { generateTitleFromUserMessage } from '@/app/[lang]/(app)/(chat)/actions';
import { type PostRequestBody, postRequestBodySchema } from '@/app/api/chat/schema';
...
export async function POST(request: Request) {
  ...
  try {
    ...
    console.log(
      '[DEBUG] execute-python has needsApproval:',
