...
import { DocumentToolCall, DocumentToolResult } from '@/components/artifacts/document';
import { InlineDocumentSkeleton } from '@/components/artifacts/document-skeleton';
