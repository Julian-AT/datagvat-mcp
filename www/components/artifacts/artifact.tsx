...
import { ArtifactMessages } from '@/components/artifacts/artifact-messages';
import { SandboxArtifact } from '@/components/artifacts/sandbox-artifact';
import type { VisibilityType } from '@/components/artifacts/visibility-selector';
...
function PureArtifact({
  ...
  const {
    ...
    artifact.documentId !== 'init' && artifact.status !== 'streaming' && artifact.kind !== 'sandbox'
                ...
                <div className="flex flex-row items-start gap-4">
                  ...
                  <div className="flex flex-col">
                    <div className="font-medium">
                      {artifact.title || activeSandbox?.title || 'Python Sandbox'}
                    </div>
