...
import { artifactDefinitions, type UIArtifact } from '@/components/artifacts/artifact';
import type { ArtifactActionContext } from '@/components/artifacts/create-artifact';
