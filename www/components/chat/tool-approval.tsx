...
import { Tool, ToolApprovalContent, ToolContent, ToolHeader } from '@/components/chat/tool';
...
export function ToolApproval({ toolCallId, toolName, code, files, onApprove }: ToolApprovalProps) {
        ...
        <ToolApprovalContent>
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-xs">
              Review the code above before approving. Execution will run in an isolated sandbox with
              a 30-second timeout.
            </p>
          </div>
        </ToolApprovalContent>
