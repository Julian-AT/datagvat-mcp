...
import { saveToolApprovalAction } from '@/app/[lang]/(app)/(chat)/actions';
import type { ArtifactKind } from '@/components/artifacts/artifact';
import { DocumentToolResult } from '@/components/artifacts/document';
import { DocumentPreview } from '@/components/artifacts/document-preview';
import { MessageContent } from '@/components/chat/chat-message-base';
...
import { Weather } from '@/components/visualization/weather';
                ...
                return (
                  <ToolApproval
                    ...
                    onApprove={async (toolCallId, approved, reason) => {
                      ...
                      console.log(
                        '[DEBUG] Calling addToolApprovalResponse with approval.id:',
                        approvalId
                      );
                      addToolApprovalResponse({
