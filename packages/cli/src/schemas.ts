...
export const ToolSelectionSchema = z
	...
	.min(
		1,
		"Tool selection cannot be empty. Select at least one tool to configure.",
	);
...
export const ConfigPathSchema = z
	...
	.refine(
		...
		{
			message:
				"Configuration path contains invalid characters. Path must be a valid file system path.",
		},
	);
